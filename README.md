...
- **[/review-changes](skills/code-review/review-changes/SKILL.md)** — Reviews the diff since a fixed point along two parallel axes — repo coding standards and the originating spec — and reports them side by side. *Auto · Trial*
