...
- **[/pr-review](skills/code-review/pr-review/SKILL.md)** — Reviews a GitLab MR or GitHub PR against its linked tracker ticket with `/review-changes`, then posts its findings as inline comments on the diff for you to submit. *Manual · Adopt*
