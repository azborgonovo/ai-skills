...
- **[/review-changes](skills/code-review/review-changes/SKILL.md)** — Reviews the diff since a fixed point with the Code Review Pyramid, splitting foundation layers from supporting ones across parallel sub-agents and reporting base-first. *Auto · Trial*
