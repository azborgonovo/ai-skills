...
- See "Keep it tight" in SKILL.md Step 10 for the same drafting habits applied here — when one option in **Proposed approach** is clearly the pick, give it the fuller explanation and dispatch the weaker one in a clause rather than mirroring its depth for symmetry.
