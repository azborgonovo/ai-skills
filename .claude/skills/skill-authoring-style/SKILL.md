---
name: skill-authoring-style
description: Formatting and prose conventions for writing or editing a SKILL.md in this repo — horizontal rules, bold usage, line wrapping, spelling, negative instructions, and when to reach for a scripts/ helper. Use whenever creating a new skill or improving an existing one in this repository.
---
